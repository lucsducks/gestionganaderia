...
var modal_container_comprador = document.getElementById(
  "modal_comprador_compra"
);
...
var modal_container_editar_proveedor = document.getElementById(
  "modal_container_editar_comprador"
);
    ...
    success: function (resp) {
      if (resp > 0) {
        if (resp == 1) {
          ...
          Swal.fire(
            "Mensaje de advertencia",
            "Ya existe el comprador en la base de datos",
            "warning"
          ).then(() => {
        ...
        Swal.fire(
          "Mensaje de Error",
          "No se pudo registrar al comprador",
          "error"
        );
      }
    },
...
function modificarComprador() {
  ...
  $.ajax({
    ...
    if (resp > 0) {
      ...
      Swal.fire(
        "Mensaje de advertencia",
        "No se pudo modificar al comprador",
        "warning"
      );
    }
  });
...
function eliminarcomprador() {
  ...
  $.ajax({
    ...
    if (resp > 0) {
      ...
      Swal.fire(
        "Mensaje de advertencia",
        "No se pudo eliminar por que tiene ganado comprado a su nombre",
        "warning"
      );
    }
  });
